...
declare class TextEditor {
  ...
  backspace(): void;
  backwardsScanInBufferRange(regex: RegExp, range: TextBuffer$RangeLike, iterator: (event: {
    match: RegExp;
    matchText: string;
  ...
  getDecorations(propertyFilter?: DecorationProperties): Array<Decoration & {
    getProperties(): DecorationProperties;
  }>;
  ...
  getHighlightDecorations(
    propertyFilter?: HighlightDecorationProperties,
  ): HighlightDecoration[];
  ...
  getLineCount(): number;
  getLineDecorations(
    propertyFilter?: LineDecorationProperties,
  ): LineDecorationProperties[];
  getLineNumberDecorations(
    propertyFilter?: LineNumberDecorationProperties,
  ...
  getOverlayDecorations(
    propertyFilter?: OverlayDecorationProperties,
  ...
  scan(regex: RegExp, iterator: (event: {
    match: number; // FIXME
    matchText: string;
  ...
  scanInBufferRange(regex: RegExp, range: TextBuffer$Range, iterator: (event: {
    match: number; // FIXME
    matchText: string;
    range: TextBuffer$Range; // FIXME
    stop(): void;
  ...
  screenPositionForBufferPosition(position: TextBuffer$PointLike, options?: {
    screenLine: boolean;
    skipSoftWrapIndentation: boolean; // FIXME: not in docs
    wrapAtSoftNewlines: boolean;
    wrapBeyondNewlines: boolean;
  ...
  scrollToBufferPosition(position: TextBuffer$PointLike, options?: {
    center: boolean;
  }): void;
  scrollToCursorPosition(options?: {
    center: boolean;
  }): void;
  scrollToScreenPosition(position: TextBuffer$PointLike, options?: {
    center: boolean;
  }): void;
  selectAll(): void;
  ...
  setCursorScreenPosition(position: TextBuffer$PointLike, options?: {
    autoscroll: boolean;
    screenLine: boolean;
    skipSoftWrapIndentation: boolean; // FIXME: not in docs
    wrapAtSoftNewlines: boolean;
  ...
  setSelectedBufferRanges(bufferRanges: TextBuffer$RangeLike[], options?: { // FIXME: are these optional?
    reversed?: boolean;
    preserveFolds?: boolean;
  }): void;
