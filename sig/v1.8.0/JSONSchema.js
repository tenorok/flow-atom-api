...
declare type JSON$SchemaArray = JSON$SchemaNode<"array", {
  default?: JSON$Value[];
...
declare type JSON$SchemaBoolean = JSON$SchemaNode<"boolean", {
  default?: boolean;
}>

declare type JSON$SchemaInteger = JSON$SchemaNode<"integer", {
  default?: number;
  multipleOf?: number;
  maximum?: number;
  minimum?: number;
...
declare type JSON$SchemaNull = JSON$SchemaNode<"null", {
  default?: null;
}>

declare type JSON$SchemaNumber = JSON$SchemaNode<"number", {
  default?: number;
  multipleOf?: number;
  maximum?: number;
  minimum?: number;
...
declare type JSON$SchemaString = JSON$SchemaNode<"string", {
  default?: string;
  maxLength?: number;
  minLength?: number;
  pattern?: string;
...
declare type JSON$SchemaObject = JSON$SchemaNode<"object", {
